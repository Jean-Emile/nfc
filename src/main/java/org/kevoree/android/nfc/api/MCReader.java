...
public class MCReader {
	...
	/**
	 * Get new instance of {@link org.kevoree.android.nfc.api.MCReader}. If the tag is "null" or if it is not a Mifare Classic
	 * tag, "null" will be returned.
	 * 
	 * @param tag The tag to operate on.
	 * @return {@link org.kevoree.android.nfc.api.MCReader} object or "null" if tag is "null" or tag is not Mifare Classic.
	 */
	 ...
	 * {@link #setKeyFile(java.io.File[])}). Also the mapping range must be specified before calling this
	...
	public SparseArray<String[]> readAsMuchAsPossible() {
		...
		while (buildNextKeyMapPart() < getSectorCount() - 1)
			;
		System.out.println("readAsMuchAsPossible");
	 ...
	 * @throws android.nfc.TagLostException When tag is lost.
	 ...
	 * {@link #setKeyFile(java.io.File[])}). If you want a full key map, you have to call
